...
public interface Appendix {
    ...
    abstract class AbstractAppendix implements Appendix {
        ...
        abstract void validate(Transaction transaction) throws AplException.ValidationException;

        void validateAtFinish(Transaction transaction) throws AplException.ValidationException {
    ...
    class Message extends AbstractAppendix {
        ...
        Message(ByteBuffer buffer) throws AplException.NotValidException {
            super(buffer);
        ...
        @Override
        void validate(Transaction transaction) throws AplException.ValidationException {
    ...
    class PrunablePlainMessage extends Appendix.AbstractAppendix implements Prunable {
        ...
        void validate(Transaction transaction) throws AplException.ValidationException {
            ...
            if (msg == null && Apl.getEpochTime() - transaction.getTimestamp() < Constants.MIN_PRUNABLE_LIFETIME) {
    ...
    abstract class AbstractEncryptedMessage extends AbstractAppendix {
        ...
        private AbstractEncryptedMessage(ByteBuffer buffer) throws AplException.NotValidException {
            super(buffer);
    ...
    class PrunableEncryptedMessage extends AbstractAppendix implements Prunable {
        ...
        void validate(Transaction transaction) throws AplException.ValidationException {
            ...
            if (ed == null && Apl.getEpochTime() - transaction.getTimestamp() < Constants.MIN_PRUNABLE_LIFETIME) {
    ...
    class EncryptedMessage extends AbstractEncryptedMessage {
        ...
        EncryptedMessage(ByteBuffer buffer) throws AplException.NotValidException {
            super(buffer);
        }
    ...
    class EncryptToSelfMessage extends AbstractEncryptedMessage {
        ...
        EncryptToSelfMessage(ByteBuffer buffer) throws AplException.NotValidException {
            super(buffer);
        }
