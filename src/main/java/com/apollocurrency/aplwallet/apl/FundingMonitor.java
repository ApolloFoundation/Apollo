...
public final class FundingMonitor {
    ...
    private static final int MAX_MONITORS = Apl.getIntProperty("apl.maxNumberOfMonitors");
    ...
    private static synchronized void init() {
        ...
        try {
            ...
            Apl.getBlockchainProcessor().addListener(new BlockEventHandler(), BlockchainProcessor.Event.BLOCK_PUSHED);
            //
            // All done
            //
            started = true;
                ...
                while (true) {
                    ...
                    while ((monitoredAccount = pendingEvents.poll()) != null) {
                        try {
                            ...
                            if (Apl.getBlockchain().getHeight() - monitoredAccount.height < monitoredAccount.interval) {
