...
public class TaggedDataFee implements Fee {
     ...
     */
    private static final int TTL_FEE_ESTABLISHED_CHAIN_HEIGHT = 100000;
    ...
    private static class DataStorageFee extends Fee.SizeAndTimeToLiveBasedFee {
        ...
        public long getTimeToLive(TransactionImpl transaction, Appendix appendage) {
            if(appendage instanceof Attachment.TaggedDataAttachment) {
                return ((Attachment.TaggedDataAttachment) appendage).getTimeToLive();
            }
            return 0;
        }
