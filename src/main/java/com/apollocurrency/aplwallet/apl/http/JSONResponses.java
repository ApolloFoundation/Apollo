...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match apl.adminPassword)");
    ...
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_TTL = incorrect("timeToLive", "should be greater than zero. Unit - seconds");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set apl.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set apl.processPolls=true and rescan");
