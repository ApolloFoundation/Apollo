...
public class APIProxy {
    ...
    private static final int blacklistingPeriod = Apl.getIntProperty("apl.apiProxyBlacklistingPeriod") / 1000;
    static final String forcedServerURL = Apl.getStringProperty("apl.forceAPIProxyServerURL", "");
    ...
    static boolean isActivated() {
        return Constants.isLightClient || (enableAPIProxy && Apl.getBlockchainProcessor().isDownloading());
    }
