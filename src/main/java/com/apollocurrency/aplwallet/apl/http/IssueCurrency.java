 ...
 * <li>When issuing a {@link com.apollocurrency.aplwallet.apl.CurrencyType#MINTABLE} currency, the number of units per {@link com.apollocurrency.aplwallet.apl.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link com.apollocurrency.aplwallet.apl.http.CurrencyMint}<br>
 * </ul>
 *
 * @see com.apollocurrency.aplwallet.apl.CurrencyType
...
public final class IssueCurrency extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long minReservePerUnit = ParameterParser.getLong(req, "minReservePerUnitATM", 1, Constants.getMaxBalanceATM(), false);
