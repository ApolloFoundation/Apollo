 ...
 * The list of founders and their ATM investment can be obtained using the {@link com.apollocurrency.aplwallet.apl.http.GetCurrencyFounders} API.
 */
...
public final class CurrencyReserveIncrease extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long amountPerUnitATM = ParameterParser.getLong(req, "amountPerUnitATM", 1L, AplGlobalObjects.getChainConfig().getCurrentConfig().getMaxBalanceAPL(), true);
