    ...
    public static abstract class Update extends TransactionType {
        ...
        void validateAttachment(Transaction transaction) throws AplException.ValidationException {
            ...
            if (attachment.getUrl().length() > Constants.MAX_UPDATE_URL_LENGTH
                ...
                throw new AplException.NotValidException("Invalid update transaction attachment. Size of signature should be < " + Constants.MAX_UPDATE_SIGNATURE_LENGTH + ". Length of url should be < " + Constants.MAX_UPDATE_URL_LENGTH + ". Attachment data: "+  attachment.getJSONObject());
            }
        }
