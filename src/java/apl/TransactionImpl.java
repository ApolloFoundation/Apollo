...
final class TransactionImpl implements Transaction {
    ...
    static BuilderImpl newTransactionBuilder(byte[] bytes) throws AplException.NotValidException {
        try {
            ...
            BuilderImpl builder = new BuilderImpl(version, senderPublicKey, amountATM, feeATM,
    ...
    static BuilderImpl newTransactionBuilder(byte[] bytes, JSONObject prunableAttachments) throws AplException.NotValidException {
    ...
    static BuilderImpl newTransactionBuilder(JSONObject transactionData) throws AplException.NotValidException {
        try {
