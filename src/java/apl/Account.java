...
public final class Account {
    ...
    void addToAssetBalanceATU(AccountLedger.LedgerEvent event, long eventId, long assetId, long quantityATU) {
        if (quantityATU == 0) {
            return;
        }
    ...
    void addToUnconfirmedAssetBalanceATU(AccountLedger.LedgerEvent event, long eventId, long assetId, long quantityATU) {
        if (quantityATU == 0) {
            return;
        }
        AccountAsset accountAsset;
    ...
    void addToAssetAndUnconfirmedAssetBalanceATU(AccountLedger.LedgerEvent event, long eventId, long assetId, long quantityATU) {
        if (quantityATU == 0) {
            return;
        }
        AccountAsset accountAsset;
