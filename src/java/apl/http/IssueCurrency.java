 ...
 * For {@link apl.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum APL value per unit to allow the currency to become active
 * For {@link apl.CurrencyType#RESERVABLE} currency
 ...
 * For {@link apl.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link apl.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link apl.crypto.HashFunction algorithm} used for minting.
 * For {@link apl.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link apl.CurrencyType#EXCHANGEABLE} nor {@link apl.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link apl.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link apl.CurrencyType#RESERVABLE} becomes active, in case it is {@link apl.CurrencyType#CLAIMABLE} the APL used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link apl.CurrencyType#RESERVABLE} becomes active, in case it is non {@link apl.CurrencyType#CLAIMABLE} the APL used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link apl.CurrencyType#MINTABLE} currency, the number of units per {@link apl.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link apl.http.CurrencyMint}<br>
 * </ul>
 *
 * @see apl.CurrencyType
 * @see apl.crypto.HashFunction
 */
public final class IssueCurrency extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long minReservePerUnit = ParameterParser.getLong(req, "minReservePerUnitNQT", 1, Constants.MAX_BALANCE_ATM, false);
