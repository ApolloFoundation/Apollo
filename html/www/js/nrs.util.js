...
var NRS = (function (NRS, $, undefined) {
    ...
    NRS.convertToAPL = function (amount, returnAsObject) {
        var negative = "";
        var mantissa = "";
    ...
    NRS.formatAmount = function (amount, round, no_escaping, zeroPad) {
        ...
        if (typeof amount == "object") {
            var params = NRS.convertToAPL(amount, true);
        ...
        if (NRS.settings) {
            ...
            var maxLength = parseInt(NRS.settings.max_apl_decimals) + offset;
    ...
    NRS.isRsAccount = function(account) {
        return NRS.isRsAccountImpl(account, NRS.constants.ACCOUNT_RS_MATCH ? NRS.constants.ACCOUNT_RS_MATCH : NRS.getRsAccountRegex("APL"));
    };
    ...
    NRS.printPaperWallet = function(passphrase) {
        var $pageHeader = $("<h2 data-i18n='apl_ardor_paper_wallet'>Apollo Paper Wallet</h2>");
