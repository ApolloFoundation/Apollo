...
var NRS = (function (NRS, $, undefined) {
    ...
    search.on("submit", function (e, data) {
        ...
        $("#buy_currency_with_apl").html($.t("buy_currency_param", { currency: currencyCode}));
        $("#buy_currency_offers").html($.t("offers_to_buy_currency_param", { currency: currencyCode}));
        $("#sell_currency_with_apl").html($.t("sell_currency_param", { currency: currencyCode}));
    ...
    $("#currency_order_modal").on("show.bs.modal", function (e) {
        ...
        $("#currency_order_total").html(totalAPL + " " + NRS.constants.COIN_SYMBOL);
