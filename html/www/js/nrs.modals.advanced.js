...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initAdvancedModalFormValues = function($modal) {
		...
		context = {
			labelText: "Amount APL",
			labelI18n: "amount_apl",
			helpI18n: "approve_transaction_amount_help",
			inputName: "phasingQuorumAPL",
			addonText: "APL",
			addonI18n: "apl_unit"
		};
		$elems = NRS.initModalUIElement($modal, '.approve_transaction_amount_apl', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		...
		context['inputName'] = 'phasingMinBalanceAPL';
		context['addonText'] = 'APL';
		context['addonI18n'] = 'apl_unit';
		$elems = NRS.initModalUIElement($modal, '.approve_min_balance_apl', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();

		context['inputName'] = 'phasingMinBalanceATUf';
