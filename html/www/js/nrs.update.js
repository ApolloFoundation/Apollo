...
var NRS = (function(NRS, $) {
	...
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "apl-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "apl-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "apl-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "apl-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "apl-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "apl-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "apl-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "apl-client-", ext: "sh"}
	];
