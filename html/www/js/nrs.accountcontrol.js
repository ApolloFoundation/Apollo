...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			...
			inputName: "controlQuorumAPL",
			addonText: "APL",
			addonI18n: "apl_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_apl', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceAPL';
		context['addonText'] = 'APL';
		context['addonI18n'] = 'apl_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_apl', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
