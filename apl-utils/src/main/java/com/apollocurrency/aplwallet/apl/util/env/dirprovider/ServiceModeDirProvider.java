...
public class ServiceModeDirProvider extends AbstractDirProvider {
    //    assume that installation dir is a directory where application executables are stored
    private static final String INSTALLATION_DIR = DirProvider.getBinDir().toAbsolutePath().getParent().toString();
