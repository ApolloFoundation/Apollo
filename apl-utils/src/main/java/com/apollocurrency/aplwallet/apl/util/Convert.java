...
public final class Convert {
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws AplException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new AplException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseAPL(String apl) {
        return parseStringFraction(apl, 8, AplGlobalObjects.getChainConfig().getCurrentConfig().getMaxBalanceAPL());
    }
