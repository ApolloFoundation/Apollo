...
public class MariaDbProcess {
    ...
    private MariaDbRunParams setDbParams(DbProperties conf, Path dbInstallDir, Path dbDataDir, Path logPath){
        ...
        String dbUser = conf.getDbUsername();
    ...
    public MariaDbProcess(DbProperties conf, Path dbInstallDir, Path dbDataDir, Path logPath) {
    ...
    */
    public static MariaDbProcess findRunning(DbProperties conf, Path dbDataDir, Path dbInstallDir, Path logPath){
