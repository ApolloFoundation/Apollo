...
class UpdateV2AttachmentTest {
    ...
    void setUp() {
        ...
        attachment = new UpdateV2Attachment("https://update.zip", Level.CRITICAL, new Version("127.3.122"), "appollo.com", BigInteger.ZERO, signature, Set.of(new PlatformSpec(OS.ALL, Arch.X86_64), new PlatformSpec(OS.ALL, Arch.X86_32), new PlatformSpec(OS.LINUX, Arch.ARM_64)));
    }
