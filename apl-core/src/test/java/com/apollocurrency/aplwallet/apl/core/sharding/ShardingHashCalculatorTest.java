...
public class ShardingHashCalculatorTest {
    ...
    @WeldSetup
    WeldInitiator weldInitiator = WeldInitiator.from(BlockchainImpl.class, BlockDaoImpl.class, DerivedDbTablesRegistry.class, EpochTime.class, GlobalSyncImpl.class, NtpTime.class, TransactionDaoImpl.class)
            .addBeans(
