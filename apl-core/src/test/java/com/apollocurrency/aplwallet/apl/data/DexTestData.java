...
public class DexTestData {
    ...
    public static final long EXCHANGE_CONTRACT_ID_4       =  7952648026362992483L ;
    public static final long EXCHANGE_CONTRACT_ID_5       =  7952648026362992483L ;
    ...
    public DexTestData() {
        ...
        DEX_CONTRACT_ATTACHMENT_1 = new DexContractAttachment(-5227805726286506078L, -7138882269097972721L,
                ...
                ExchangeContractStatus.STEP_1, Constants.DEX_MIN_CONTRACT_TIME_WAITING_TO_REPLY);
        ...
        DEX_CONTRACT_ATTACHMENT_4 = new DexContractAttachment(6735355323156389437L, 3332621836748752862L,
                ...
                null,
                ExchangeContractStatus.STEP_1, Constants.DEX_MIN_CONTRACT_TIME_WAITING_TO_REPLY);
        DEX_CONTRACT_ATTACHMENT_5 = new DexContractAttachment(-3102348866139658976L, -4688237877525140429L,
                null, null, null,
                null,
                ExchangeContractStatus.STEP_1, Constants.DEX_MIN_CONTRACT_TIME_WAITING_TO_REPLY);
        ...
        DEX_CONTRACT_ATTACHMENT_11 = new DexContractAttachment(-2946834708490131834L, -6968465014361285240L,
                null, null, null,
                null,
                ExchangeContractStatus.STEP_4, Constants.DEX_MIN_CONTRACT_TIME_WAITING_TO_REPLY);
        ...
        EXCHANGE_CONTRACT_4 = new ExchangeContract(40L, EXCHANGE_CONTRACT_ID_4, 7477442401604846627L, -582612439131997299L, 53499983, DEX_CONTRACT_ATTACHMENT_4, 400, false);
        EXCHANGE_CONTRACT_5 = new ExchangeContract(50L, EXCHANGE_CONTRACT_ID_5, -582612439131997299L, 7477442401604846627L, 53500038, DEX_CONTRACT_ATTACHMENT_5, 400, false);
