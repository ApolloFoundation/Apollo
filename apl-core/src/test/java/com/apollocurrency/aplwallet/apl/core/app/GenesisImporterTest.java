...
import com.apollocurrency.aplwallet.apl.core.config.ResourceLocatorProducer;
...
import com.apollocurrency.aplwallet.apl.core.service.state.account.impl.TwoTablesPublicKeyDao;
...
class GenesisImporterTest extends DbContainerBaseTest {
    ...
    static Bean<?> createCfgdDirProviderBean() {
        ...
        ConfigDirProvider instance = ConfigDirProviderFactory.getConfigDirProvider();
    ...
    public WeldInitiator weld = WeldInitiator.from(AccountGuaranteedBalanceTable.class, PublicKeyTableProducer.class,
        ...
        ResourceLocatorProducer.class, JdbiHandleFactory.class, JdbiConfiguration.class
    )
