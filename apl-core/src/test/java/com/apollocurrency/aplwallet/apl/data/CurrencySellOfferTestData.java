...
public class CurrencySellOfferTestData {

    public CurrencySellOffer OFFER_0 = createOffer(
    ...
    public CurrencySellOffer OFFER_1 = createOffer(
    ...
    public CurrencySellOffer OFFER_2 = createOffer(
    ...
    public CurrencySellOffer OFFER_3 = createOffer(
    ...
    public CurrencySellOffer OFFER_4 = createOffer(
    ...
    public CurrencySellOffer OFFER_5 = createOffer(
    ...
    public CurrencySellOffer OFFER_6 = createOffer(
    ...
    public CurrencySellOffer OFFER_7 = createOffer(
    ...
    public CurrencySellOffer OFFER_8 = createOffer(
    ...
    public CurrencySellOffer OFFER_NEW = createNewOffer(
        3697010724017000011L,    1029902366663005623L,    7000442401604846627L, 1,
        999,        1,      999999999,           (short)1383322,         (short)0,
        1383322,         1383324, true, false);


    private CurrencySellOffer createOffer(
        ...
        CurrencySellOffer offer = new CurrencySellOffer(id, currencyId, accountId, rateATM, limit, supply,
    ...
    private CurrencySellOffer createNewOffer(
