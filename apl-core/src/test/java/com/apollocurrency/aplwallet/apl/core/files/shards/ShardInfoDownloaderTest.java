...
public class ShardInfoDownloaderTest {
    ...
    /**
     * Test of getSortedShards method, of class ShardInfoDownloader.
     */
    @Test
    public void testGetSortedShards() {
        System.out.println("getSortedShards");
        ShardInfoDownloader instance = null;
        Map<Long, Set<ShardInfo>> expResult = null;
        Map<Long, Set<ShardInfo>> result = instance.getSortedShards();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
