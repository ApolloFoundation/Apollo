...
class ShardDaoTest extends DbContainerBaseTest {
    ...
    DaoConfig daoConfig;
    @Inject
    GlobalSyncImpl globalSync;
    @Inject
    TransactionRowMapper transactionRowMapper;
    @Inject
    DerivedDbTablesRegistryImpl derivedDbTablesRegistry;
    @Inject
    ...
    @Inject
    JdbiHandleFactory jdbiHandleFactory = extension.getDatabaseManager().getJdbiHandleFactory();
    @Inject
    DatabaseManager databaseManager = extension.getDatabaseManager();
    @Inject
    BlockIndexServiceImpl blockIndexService;
    @Inject
    PublicKeyDao publicKeyDao;
    @Inject
    PrunableLoadingService prunableLoadingService;
    @Inject
    TransactionTypeFactory transactionTypeFactory = td.getTransactionTypeFactory();
