...
public class ShardTestData {
    ...
    public static final Shard NOT_SAVED_SHARD = new Shard(3L, Convert.parseHexString("7a496e38973387732394ff257e73cd3e57165ed2f0ab1855d497ff6b14fd0678"));
    public static final List<Shard> SHARDS = Arrays.asList(SHARD_0, SHARD_1);
}
