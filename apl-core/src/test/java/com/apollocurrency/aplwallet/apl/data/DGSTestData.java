...
public class DGSTestData {
    ...
    public final DGSPurchase PURCHASE_0  = createPurchase(50	,7052449049531083429L,   BUYER_0_ID, GOODS_0_ID	    ,SELLER_0_ID    ,1	,100000000000L	,173056826	,null	,null	,41815212	,false	,"d0e9017bfa6d02bf823e2cc5973f1ce8146ed7155ac326afb77a41d4ff2737f134a28e29be0c01357aee9660dca00a37"	                                ,"47d7e125d33917ad2efe5cb34c754816541b3862056cae7672e8faea3fdb6c97"	,true	        ,null	        ,null	        ,false	                ,false	                 ,100000000	,0	        ,541915	    ,false,  null, null);
    ...
    public final DGSPurchase PURCHASE_4  = createPurchase(54	,7052449049531083429L,   BUYER_0_ID, GOODS_0_ID	    ,SELLER_0_ID    ,1	,100000000000L	,173056826	,null	,null	,41815212	,false	,"d0e9017bfa6d02bf823e2cc5973f1ce8146ed7155ac326afb77a41d4ff2737f134a28e29be0c01357aee9660dca00a37"	                                ,"47d7e125d33917ad2efe5cb34c754816541b3862056cae7672e8faea3fdb6c97"	,true	        ,null	        ,null	        ,false	                ,true	                 ,100000000	,0	        ,541965	    ,false, PURCHASE_0_PUBLIC_FEEDBACKS, null);
    public final DGSPurchase PURCHASE_5  = createPurchase(55	,7052449049531083429L,   BUYER_0_ID, GOODS_0_ID	    ,SELLER_0_ID    ,1	,100000000000L	,173056826	,null	,null	,41815212	,false	,"d0e9017bfa6d02bf823e2cc5973f1ce8146ed7155ac326afb77a41d4ff2737f134a28e29be0c01357aee9660dca00a37"	                                ,"47d7e125d33917ad2efe5cb34c754816541b3862056cae7672e8faea3fdb6c97"	,true	        ,null	        ,null	        ,true	                ,true	                 ,100000000	,0	        ,542010	    ,true , PURCHASE_0_PUBLIC_FEEDBACKS, PURCHASE_0_FEEDBACKS);
    ...
    public final DGSGoods GOODS_0  = createGoods(54,	 GOODS_0_ID	                ,SELLER_0_ID	,"Some product"	    ,"Some product Some product"	    ,new String[]{"product","some","ptd"}	,true	,"product some ptd test"    	,41814871	,2	        ,100000000000L	,false	    ,541839	    ,false);
    public final DGSGoods GOODS_1  = createGoods(55,	 GOODS_0_ID	                ,SELLER_0_ID	,"Some product"	    ,"Some product Some product"	    ,new String[]{"product","some","ptd"}	,true	,"product some ptd test"    	,41814871	,1	        ,100000000000L	,false	    ,541867	    ,false);
    public final DGSGoods GOODS_2  = createGoods(56,	 GOODS_0_ID	                ,SELLER_0_ID	,"Some product"	    ,"Some product Some product"	    ,new String[]{"product","some","ptd"}	,true	,"product some ptd test"    	,41814871	,0	        ,100000000000L	,false	    ,541874	    ,true );
