...
class ShardDaoTest extends DbContainerBaseTest {
    ...
    TimeService timeService = new TimeServiceImpl(config.timeSource());    TransactionTestData td = new TransactionTestData();

    @WeldSetup
    public WeldInitiator weld = WeldInitiator.from(
         BlockchainImpl.class, DaoConfig.class, ShardDao.class,
