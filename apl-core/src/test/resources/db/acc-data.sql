...
(DB_ID, ID, BALANCE, UNCONFIRMED_BALANCE, HAS_CONTROL_PHASING, FORGED_BALANCE, ACTIVE_LESSEE_ID, HEIGHT, LATEST,
 DELETED)
values (1, 1739068987193023818, 999990000000000, 999990000000000, false, 0, null, 0, true, false),
...
(DB_ID, ACCOUNT_ID, ASSET_ID, QUANTITY, UNCONFIRMED_QUANTITY, HEIGHT, LATEST)
VALUES (2, 100, 10, 8, 8, 42716, true),
...
(DB_ID, ACCOUNT_ID, CURRENCY_ID, UNITS, UNCONFIRMED_UNITS, HEIGHT, LATEST)
VALUES (4, 100, 10, 2000000, 2000000, 9800, true),
...
INSERT INTO account_guaranteed_balance
    (DB_ID, ACCOUNT_ID, ADDITIONS, HEIGHT)
VALUES (1695301, 100, 27044000000, 2502007),
...
(DB_ID, ACCOUNT_ID, EVENT_TYPE, EVENT_ID, HOLDING_TYPE, HOLDING_ID, `CHANGE`, BALANCE, BLOCK_ID, HEIGHT, `TIMESTAMP`)
VALUES (53, 110, 3, -7204505074792164093, 1, null, 250000000000000, 250000000000000, 4994769695807437270, 827, 1054211),
       ...
       (67, 120, 3, -5312761317760960087, 1, null, -250000000000000, 2691750001300000000, 7971792663971279902, 846,
        1055410),
...
INSERT INTO account_property
    (DB_ID, ID, RECIPIENT_ID, SETTER_ID, PROPERTY, VALUE, HEIGHT, LATEST)
VALUES (1, 10, 100, null, 'email', 'dchosrova@gmail.com', 94335, true),
...
(DB_ID, LESSOR_ID, CURRENT_LEASING_HEIGHT_FROM, CURRENT_LEASING_HEIGHT_TO, CURRENT_LESSEE_ID, NEXT_LEASING_HEIGHT_FROM,
 NEXT_LEASING_HEIGHT_TO, NEXT_LESSEE_ID, HEIGHT, LATEST)
VALUES (1, 100, 10000, 11000, 10, 0, 0, 0, 10000, true),
