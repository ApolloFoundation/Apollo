...
values (1, 10, 999990000000000, 999990000000000, false, 0, null, 0, true),
...
(DB_ID, ID, LESSOR_ID, CURRENT_LEASING_HEIGHT_FROM, CURRENT_LEASING_HEIGHT_TO, CURRENT_LESSEE_ID,
 NEXT_LEASING_HEIGHT_FROM, NEXT_LEASING_HEIGHT_TO, NEXT_LESSEE_ID, HEIGHT, LATEST)
VALUES (1, 1000, 100, 7000, 11000, 10, 0, 0, 0, 5000, true),
