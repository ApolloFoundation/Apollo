 ...
 * Clients first submit their transaction using {@link com.apollocurrency.aplwallet.apl.core.http.CreateTransaction} without providing the secret phrase.<br>
 * In response the client receives the unsigned transaction JSON and transaction bytes.
 * <p>
 * The client then signs and submits the signed transaction using {@link com.apollocurrency.aplwallet.apl.core.http.BroadcastTransaction}
 * <p>
 * The default wallet implements this procedure in ars.server.js which you can use as reference.
 * <p>
 * {@link com.apollocurrency.aplwallet.apl.core.http.BroadcastTransaction} accepts the following parameters:<br>
