...
public class UnencryptedPrunableEncryptedMessage extends PrunableEncryptedMessage implements Appendix.Encryptable {

    private final byte[] messageToEncrypt;
    private final byte[] recipientPublicKey;

    public UnencryptedPrunableEncryptedMessage(JSONObject attachmentJSON) {
