...
public class DexOrderProcessor {
    ...
    @Inject
    public DexOrderProcessor(SecureStorageService secureStorageService, TransactionValidator validator,
                             DexService dexService, DexOrderTransactionCreator dexOrderTransactionCreator,
                             DexValidationServiceImpl dexValidationServiceImpl, DexSmartContractService dexSmartContractService,
    ...
    private CreateTransactionRequest buildRequest(String passphrase, Long accountId, Attachment attachment, Long feeATM) throws ParameterException {
        CreateTransactionRequest transferMoneyReq = CreateTransactionRequest
                ...
                .deadlineValue("1440")
                .publicKey(accountService.getPublicKey(accountId))
