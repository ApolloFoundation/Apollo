...
public final class GetAssetAccounts extends AbstractAPIRequestHandler {
    ...
    public JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long assetId = HttpParameterParser.getUnsignedLong(req, "asset", true);
        ...
        List<AccountAsset> assets = lookupAccountAssetService().getAssets(assetId, height, firstIndex, lastIndex);
