...
public enum APIEnum {
    ...
    @Obsolete GET_ACCOUNT_BLOCK_COUNT("getAccountBlockCount", new GetAccountBlockCount()),
    @Obsolete GET_ACCOUNT_BLOCK_IDS("getAccountBlockIds", new GetAccountBlockIds()),
    @Obsolete GET_ACCOUNT_BLOCKS("getAccountBlocks", new GetAccountBlocks()),
    ...
    @Obsolete GET_ACCOUNT_ASSETS("getAccountAssets", new GetAccountAssets()),
    @Obsolete GET_ACCOUNT_CURRENCIES("getAccountCurrencies", new GetAccountCurrencies()),
    @Obsolete GET_ACCOUNT_CURRENCY_COUNT("getAccountCurrencyCount", new GetAccountCurrencyCount()),
    @Obsolete GET_ACCOUNT_ASSET_COUNT("getAccountAssetCount", new GetAccountAssetCount()),
