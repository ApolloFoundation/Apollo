...
public final class CurrencyMint extends CreateTransaction {
    ...
    public JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long nonce = HttpParameterParser.getLong(req, "nonce", Long.MIN_VALUE, Long.MAX_VALUE, true);
        long units = HttpParameterParser.getLong(req, "units", 0, Long.MAX_VALUE, true);
        long counter = HttpParameterParser.getLong(req, "counter", 0, Integer.MAX_VALUE, true);
