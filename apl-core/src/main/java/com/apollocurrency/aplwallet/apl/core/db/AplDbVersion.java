...
public class AplDbVersion extends DbVersion {
    ...
    protected int update(int nextUpdate) {
        switch (nextUpdate) {
            case 1:
                apply("CREATE TABLE IF NOT EXISTS block (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, version INT NOT NULL, "
                        + "\"timestamp\" INT NOT NULL, previous_block_id BIGINT, "
                        + "total_amount BIGINT NOT NULL, "
                        + "total_fee BIGINT NOT NULL, payload_length INT NOT NULL, "
                        + "previous_block_hash BYTEA, cumulative_difficulty BYTEA NOT NULL, base_target BIGINT NOT NULL, "
                        + "next_block_id BIGINT, "
                        + "height INT NOT NULL, generation_signature BYTEA NOT NULL, "
                        + "block_signature BYTEA NOT NULL, payload_hash BYTEA NOT NULL, generator_id BIGINT NOT NULL)");
            case 2:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS block_id_idx ON block (id)");
            case 3:
                apply("CREATE TABLE IF NOT EXISTS transaction (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
                        + "deadline SMALLINT NOT NULL, recipient_id BIGINT, transaction_index SMALLINT NOT NULL, "
                        + "amount BIGINT NOT NULL, fee BIGINT NOT NULL, full_hash BYTEA NOT NULL, "
                        + "height INT NOT NULL, block_id BIGINT NOT NULL, "
                        + "signature BYTEA NOT NULL, \"timestamp\" INT NOT NULL, type SMALLINT NOT NULL, subtype SMALLINT NOT NULL, "
                        + "sender_id BIGINT NOT NULL, sender_public_key BYTEA, block_timestamp INT NOT NULL, referenced_transaction_full_hash BYTEA, "
                        + "phased BOOLEAN NOT NULL DEFAULT FALSE, "
                        + "attachment_bytes BYTEA, version SMALLINT NOT NULL, has_message BOOLEAN NOT NULL DEFAULT FALSE, "
            ...
            case 11:
                apply("CREATE TABLE IF NOT EXISTS alias (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
                        + "account_id BIGINT NOT NULL, alias_name VARCHAR NOT NULL, "
                        + "alias_name_lower VARCHAR GENERATED ALWAYS AS ( LOWER(alias_name) ) STORED NOT NULL, "
            ...
            case 15:
                apply("CREATE TABLE IF NOT EXISTS alias_offer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 17:
                apply("CREATE TABLE IF NOT EXISTS asset (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, description VARCHAR, quantity BIGINT NOT NULL, decimals SMALLINT NOT NULL, "
            ...
            case 19:
                apply("CREATE TABLE IF NOT EXISTS trade (db_id BIGINT GENERATED ALWAYS AS IDENTITY, asset_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
            ...
            case 23:
                apply("CREATE TABLE IF NOT EXISTS ask_order (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 27:
                apply("CREATE TABLE IF NOT EXISTS bid_order (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "asset_id BIGINT NOT NULL, price BIGINT NOT NULL, transaction_index SMALLINT NOT NULL, "
                        + "transaction_height INT NOT NULL, "
                        + "quantity BIGINT NOT NULL, creation_height INT NOT NULL, height INT NOT NULL, "
                        + "latest BOOLEAN NOT NULL DEFAULT TRUE)");
            ...
            case 31:
                apply("CREATE TABLE IF NOT EXISTS goods (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, seller_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, description VARCHAR, parsed_tags TEXT[], has_image BOOLEAN NOT NULL, "
            ...
            case 35:
                apply("CREATE TABLE IF NOT EXISTS purchase (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, buyer_id BIGINT NOT NULL, "
                        + "goods_id BIGINT NOT NULL, "
                        + "seller_id BIGINT NOT NULL, quantity INT NOT NULL, "
                        + "price BIGINT NOT NULL, deadline INT NOT NULL, note BYTEA, nonce BYTEA, "
                        + "\"timestamp\" INT NOT NULL, pending BOOLEAN NOT NULL, goods BYTEA, goods_nonce BYTEA, goods_is_text BOOLEAN NOT NULL DEFAULT TRUE, "
                        + "refund_note BYTEA, refund_nonce BYTEA, has_feedback_notes BOOLEAN NOT NULL DEFAULT FALSE, "
            ...
            case 40:
                apply("CREATE TABLE IF NOT EXISTS account (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 42:
                apply("CREATE TABLE IF NOT EXISTS account_asset (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 44:
                apply("CREATE TABLE IF NOT EXISTS account_guaranteed_balance (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 46:
                apply("CREATE TABLE IF NOT EXISTS purchase_feedback (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, feedback_data BYTEA NOT NULL, "
                        + "feedback_nonce BYTEA NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 47:
                apply("CREATE INDEX IF NOT EXISTS purchase_feedback_id_height_idx ON purchase_feedback (id, height DESC)");
            case 48:
                apply("CREATE TABLE IF NOT EXISTS purchase_public_feedback (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, public_feedback "
            ...
            case 50:
                apply("CREATE TABLE IF NOT EXISTS unconfirmed_transaction (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, expiration INT NOT NULL, "
                        + "transaction_height INT NOT NULL, fee_per_byte BIGINT NOT NULL, arrival_timestamp BIGINT NOT NULL, "
                        + "transaction_bytes BYTEA NOT NULL, prunable_json VARCHAR, height INT NOT NULL)");
            case 51:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS unconfirmed_transaction_id_idx ON unconfirmed_transaction (id)");
            case 52:
                apply("CREATE TABLE IF NOT EXISTS asset_transfer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
            ...
            case 62:
                apply("CREATE TABLE IF NOT EXISTS tag (db_id BIGINT GENERATED ALWAYS AS IDENTITY, tag VARCHAR NOT NULL, in_stock_count INT NOT NULL, "
            ...
            case 65:
                apply("CREATE TABLE IF NOT EXISTS currency (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, name_lower VARCHAR GENERATED ALWAYS AS ( LOWER(name) ) STORED NOT NULL, code VARCHAR NOT NULL, "
                        ...
                        + "min_reserve_per_unit_nqt BIGINT NOT NULL, min_difficulty SMALLINT NOT NULL, "
                        + "max_difficulty SMALLINT NOT NULL, ruleset SMALLINT NOT NULL, algorithm SMALLINT NOT NULL, "
            ...
            case 68:
                apply("CREATE TABLE IF NOT EXISTS account_currency (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 70:
                apply("CREATE TABLE IF NOT EXISTS currency_founder (db_id BIGINT GENERATED ALWAYS AS IDENTITY, currency_id BIGINT NOT NULL, "
            ...
            case 72:
                apply("CREATE TABLE IF NOT EXISTS currency_mint (db_id BIGINT GENERATED ALWAYS AS IDENTITY, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 74:
                apply("CREATE TABLE IF NOT EXISTS buy_offer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL,"
            ...
            case 77:
                apply("CREATE TABLE IF NOT EXISTS sell_offer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "rate BIGINT NOT NULL, unit_limit BIGINT NOT NULL, supply BIGINT NOT NULL, expiration_height INT NOT NULL, "
                        + "creation_height INT NOT NULL, transaction_index SMALLINT NOT NULL, transaction_height INT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 78:
            ...
            case 80:
                apply("CREATE TABLE IF NOT EXISTS exchange (db_id BIGINT GENERATED ALWAYS AS IDENTITY, transaction_id BIGINT NOT NULL, currency_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
            ...
            case 85:
                apply("CREATE TABLE IF NOT EXISTS currency_transfer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, "
            ...
            case 99:
                apply("CREATE TABLE IF NOT EXISTS currency_supply (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 101:
                apply("CREATE TABLE IF NOT EXISTS public_key (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
                        + "public_key BYTEA, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 102:
            ...
            case 107:
                apply("CREATE TABLE IF NOT EXISTS vote (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, " +
                        "poll_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, vote_bytes BYTEA NOT NULL, height INT NOT NULL)");
            case 108:
            ...
            case 110:
                apply("CREATE TABLE IF NOT EXISTS poll (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
                        + "account_id BIGINT NOT NULL, name VARCHAR NOT NULL, "
                        + "description VARCHAR, options text[] NOT NULL, min_num_options SMALLINT, max_num_options SMALLINT, "
                        + "min_range_value SMALLINT, max_range_value SMALLINT, \"timestamp\" INT NOT NULL, "
                        + "finish_height INT NOT NULL, voting_model SMALLINT NOT NULL, min_balance BIGINT, "
                        + "min_balance_model SMALLINT, holding_id BIGINT, height INT NOT NULL)");
            case 111:
                apply("CREATE TABLE IF NOT EXISTS poll_result (db_id BIGINT GENERATED ALWAYS AS IDENTITY, poll_id BIGINT NOT NULL, "
                        + "result BIGINT, weight BIGINT NOT NULL, height INT NOT NULL)");
            case 112:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
                        + "account_id BIGINT NOT NULL, whitelist_size SMALLINT NOT NULL DEFAULT 0, "
                        + "finish_height INT NOT NULL, voting_model SMALLINT NOT NULL, quorum BIGINT, "
                        + "min_balance BIGINT, holding_id BIGINT, min_balance_model SMALLINT, "
                        + "hashed_secret BYTEA, algorithm SMALLINT, height INT NOT NULL)");
            case 113:
                apply("CREATE TABLE IF NOT EXISTS phasing_vote (db_id BIGINT GENERATED ALWAYS AS IDENTITY, vote_id BIGINT NOT NULL, "
                        + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                        + "height INT NOT NULL)");
            case 114:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_voter (db_id BIGINT GENERATED ALWAYS AS IDENTITY, "
                        + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                        + "height INT NOT NULL)");
            case 115:
            ...
            case 128:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_result (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 136:
                apply("CREATE TABLE IF NOT EXISTS account_info (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 138:
                apply("CREATE TABLE IF NOT EXISTS prunable_message (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, sender_id BIGINT NOT NULL, "
                        + "recipient_id BIGINT, message BYTEA, message_is_text BOOLEAN NOT NULL, is_compressed BOOLEAN NOT NULL, "
                        + "encrypted_message BYTEA, encrypted_is_text BOOLEAN DEFAULT FALSE, "
            ...
            case 144:
                apply("CREATE TABLE IF NOT EXISTS tagged_data (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, description VARCHAR, tags VARCHAR, parsed_tags text[], type VARCHAR, data BYTEA NOT NULL, "
            ...
            case 149:
                apply("CREATE TABLE IF NOT EXISTS data_tag (db_id BIGINT GENERATED ALWAYS AS IDENTITY, tag VARCHAR NOT NULL, tag_count INT NOT NULL, "
                        + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 150:
            ...
            case 152:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_timestamp (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, \"timestamp\" INT NOT NULL, "
                        + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 153:
            ...
            case 156:
                apply("CREATE TABLE IF NOT EXISTS account_lease (db_id BIGINT GENERATED ALWAYS AS IDENTITY, lessor_id BIGINT NOT NULL, "
            ...
            case 187:
                apply("CREATE TABLE IF NOT EXISTS exchange_request (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 193:
                apply("CREATE TABLE IF NOT EXISTS account_ledger (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
                        + "event_type SMALLINT NOT NULL, event_id BIGINT NOT NULL, holding_type SMALLINT NOT NULL, "
            ...
            case 196:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_extend (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 213:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_linked_transaction (db_id BIGINT GENERATED ALWAYS AS IDENTITY, "
                        + "transaction_id BIGINT NOT NULL, linked_full_hash BYTEA NOT NULL, linked_transaction_id BIGINT NOT NULL, "
                        + "height INT NOT NULL)");
            case 214:
            ...
            case 217:
                apply("CREATE TABLE IF NOT EXISTS account_control_phasing (db_id BIGINT GENERATED ALWAYS AS IDENTITY, account_id BIGINT NOT NULL, "
                        + "whitelist BIGINT[], voting_model SMALLINT NOT NULL, quorum BIGINT, min_balance BIGINT, "
                        + "holding_id BIGINT, min_balance_model SMALLINT, max_fees BIGINT, min_duration SMALLINT, max_duration SMALLINT, "
                        + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 218:
            ...
            case 220:
                apply("CREATE TABLE IF NOT EXISTS account_property (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, recipient_id BIGINT NOT NULL, setter_id BIGINT, "
            ...
            case 225:
                apply("CREATE TABLE IF NOT EXISTS asset_delete (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
            ...
            case 230:
                apply("CREATE TABLE IF NOT EXISTS referenced_transaction (db_id BIGINT GENERATED ALWAYS AS IDENTITY, transaction_id BIGINT NOT NULL, "
            ...
            case 233:
                apply("CREATE TABLE IF NOT EXISTS asset_dividend (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
            ...
            case 239:
                apply("CREATE TABLE IF NOT EXISTS update_status ("
                        + "db_id BIGINT GENERATED ALWAYS AS IDENTITY, "
            ...
            case 252:
                ...
                apply("CREATE TABLE IF NOT EXISTS shard (shard_id BIGINT NOT NULL, shard_hash BYTEA, " +
                        "shard_height INT not null default 0, shard_state BIGINT default 0, zip_hash_crc BYTEA, generator_ids BIGINT[] DEFAULT NULL, block_timeouts INTEGER[] DEFAULT NULL, block_timestamps INTEGER[] DEFAULT NULL, prunable_zip_hash BYTEA DEFAULT NULL)");
            case 253:
                //apply("alter table shard add constraint IF NOT EXISTS PRIMARY_KEY_SHARD_ID primary key (shard_id)"); // primary key + index
                apply("DO $$\n" +
                        "    BEGIN\n" +
                        "        IF NOT EXISTS(SELECT 1 FROM pg_constraint WHERE conname = 'primary_key_shard_id')\n" +
                        "        THEN\n" +
                        "            alter table shard\n" +
                        "                add constraint PRIMARY_KEY_SHARD_ID primary key (shard_id);\n" +
                        "        END IF;\n" +
                        "    END$$;");
            case 254:
            ...
            case 258:
                apply("CREATE TABLE IF NOT EXISTS transaction_shard_index (transaction_id BIGINT NOT NULL, partial_transaction_hash BYTEA NOT NULL, transaction_index SMALLINT NOT NULL, height INT NOT NULL)");
            case 259:
            ...
            case 261:
                apply("CREATE TABLE IF NOT EXISTS shard_recovery (shard_recovery_id BIGINT GENERATED ALWAYS AS IDENTITY, " +
            ...
            case 262:
                ...
                apply("DO $$\n" +
                        "    BEGIN\n" +
                        "        IF NOT EXISTS(SELECT 1 FROM pg_constraint WHERE conname = 'pk_shard_recovery_state')\n" +
                        "        THEN\n" +
                        "            alter table shard_recovery\n" +
                        "                add constraint pk_shard_recovery_state primary key (shard_recovery_id);\n" +
                        "        END IF;\n" +
                        "    END$$;");
            case 263:
                ...
                apply("DO $$\n" +
                        "    BEGIN\n" +
                        "        IF NOT EXISTS(SELECT 1 FROM pg_constraint WHERE conname = 'shard_recovery_id_state_object_idx')\n" +
                        "        THEN\n" +
                        "            alter table shard_recovery\n" +
                        "                add constraint shard_recovery_id_state_object_idx unique (shard_recovery_id, state);\n" +
                        "        END IF;\n" +
                        "    END$$;");
            case 264:
                //DUPLICATE
            ...
            case 270:
                apply("CREATE TABLE IF NOT EXISTS dex_offer (db_id BIGINT GENERATED ALWAYS AS IDENTITY, transaction_id BIGINT NOT NULL, type SMALLINT NOT NULL, " +
                        "account_id BIGINT NOT NULL, offer_currency SMALLINT NOT NULL, offer_amount BIGINT NOT NULL, pair_currency SMALLINT NOT NULL, " +
                        "pair_rate DECIMAL NOT NULL, finish_time INT NOT NULL, status SMALLINT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 271 :
            ...
            case 281:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS zip_hash_crc BYTEA");
            case 282:
            ...
            case 295:
                apply("ALTER TABLE shuffling_participant ADD COLUMN IF NOT EXISTS data_hash BYTEA");
            case 296:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS generator_ids BIGINT[] DEFAULT NULL");
            case 297:
                apply("CREATE TABLE IF NOT EXISTS trim(db_id BIGINT GENERATED ALWAYS AS IDENTITY, height INT NOT NULL, done BOOLEAN NOT NULL DEFAULT FALSE)");
            case 298:
                apply("ALTER TABLE IF EXISTS shard_recovery ADD COLUMN IF NOT EXISTS height INT NOT NULL");
            case 299:
                apply("ALTER TABLE IF EXISTS shard ADD COLUMN IF NOT EXISTS block_timeouts integer[] DEFAULT NULL");
            case 300:
                apply("ALTER TABLE IF EXISTS shard ADD COLUMN IF NOT EXISTS block_timestamps integer[] DEFAULT NULL");
            case 301:
                apply("CREATE TABLE IF NOT EXISTS dex_contract (db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, offer_id BIGINT NOT NULL, " +
                        "counter_offer_id BIGINT NOT NULL, secret_hash CHAR(64), height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE," +
                        " deadline_to_reply INT NOT NULL)");
            case 302:
                apply("CREATE TABLE IF NOT EXISTS dex_trade (db_id BIGINT GENERATED ALWAYS AS IDENTITY, transaction_id BIGINT not null, sender_offer_id BIGINT not null, " +
                        "RECEIVER_OFFER_ID BIGINT not null, SENDER_OFFER_TYPE SMALLINT not null, SENDER_OFFER_CURRENCY SMALLINT not null, " +
                        "SENDER_OFFER_AMOUNT BIGINT not null, PAIR_CURRENCY SMALLINT not null, PAIR_RATE DECIMAL not null, FINISH_TIME INT not null, " +
                        "HEIGHT INT not null )");
            case 303:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS prunable_zip_hash BYTEA DEFAULT NULL");
            case 304:
                apply("ALTER TABLE dex_contract ALTER COLUMN secret_hash TYPE BYTEA USING secret_hash::bytea");
                apply("ALTER TABLE dex_contract ALTER COLUMN secret_hash SET DEFAULT NULL");
            case 305:
                apply("ALTER TABLE dex_contract ADD COLUMN IF NOT EXISTS status SMALLINT NOT NULL ");
            case 306:
            ...
            case 308:
                apply("ALTER TABLE dex_contract ADD COLUMN IF NOT EXISTS encrypted_secret BYTEA NULL DEFAULT NULL");
            case 309:
            ...
            case 311:
                apply("CREATE TABLE IF NOT EXISTS phasing_approval_tx (db_id BIGINT GENERATED ALWAYS AS IDENTITY, phasing_tx BIGINT NOT NULL, approved_tx BIGINT NOT NULL," +
                        " height INT NOT NULL)");
            case 312:
                apply(  "CREATE TABLE IF NOT EXISTS dex_trade (db_id BIGINT GENERATED ALWAYS AS IDENTITY, transaction_id BIGINT not null, sender_offer_id BIGINT not null, " +
                        "RECEIVER_OFFER_ID BIGINT not null, SENDER_OFFER_TYPE SMALLINT not null, SENDER_OFFER_CURRENCY SMALLINT not null, " +
            ...
            case 316:
                apply("CREATE TABLE IF NOT EXISTS mandatory_transaction " +
                        "(db_id BIGINT GENERATED ALWAYS AS IDENTITY, id BIGINT NOT NULL, transaction_bytes BYTEA NOT NULL, required_tx_hash BYTEA)");
            case 317:
