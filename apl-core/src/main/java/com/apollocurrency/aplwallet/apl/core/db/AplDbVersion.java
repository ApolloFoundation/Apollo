...
public class AplDbVersion extends DbVersion {
    ...
    protected int update(int nextUpdate) {
        switch (nextUpdate) {
            case 1:
                apply("CREATE TABLE IF NOT EXISTS block (db_id SERIAL, id BIGINT NOT NULL, version INT NOT NULL, "
                    + "`TIMESTAMP` INT NOT NULL, previous_block_id BIGINT, "
                    + "total_amount BIGINT NOT NULL, "
                    + "total_fee BIGINT NOT NULL, payload_length INT NOT NULL, "
                    + "previous_block_hash BINARY(32), cumulative_difficulty BLOB NOT NULL, base_target BIGINT NOT NULL, "
                    + "next_block_id BIGINT, "
                    + "height INT NOT NULL, generation_signature BINARY(32) NOT NULL, "
                    + "block_signature BINARY(64) NOT NULL, payload_hash BINARY(32) NOT NULL, generator_id BIGINT NOT NULL) ENGINE=ROCKSDB;");
            case 2:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS block_id_idx ON block (id)");
            case 3:
                apply("CREATE TABLE IF NOT EXISTS transaction (db_id SERIAL, id BIGINT NOT NULL, "
                    ...
                    + "attachment_bytes BLOB, version TINYINT NOT NULL, has_message BOOLEAN NOT NULL DEFAULT FALSE, "
            ...
            case 9:
                apply("CREATE TABLE IF NOT EXISTS peer (address VARCHAR(191) PRIMARY KEY, last_updated INT, services BIGINT) ENGINE=ROCKSDB;");
            case 10:
                apply("CREATE INDEX IF NOT EXISTS transaction_block_timestamp_idx ON transaction (block_timestamp DESC)");
            case 11:
                apply("CREATE TABLE IF NOT EXISTS alias (db_id SERIAL, id BIGINT NOT NULL, "
                    + "account_id BIGINT NOT NULL, alias_name VARCHAR(255) NOT NULL, "
                    + "alias_name_lower VARCHAR(255) NOT NULL, "
                    + "alias_uri VARCHAR(255) NOT NULL, `TIMESTAMP` INT NOT NULL, "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 12:
            ...
            case 15:
                apply("CREATE TABLE IF NOT EXISTS alias_offer (db_id SERIAL, id BIGINT NOT NULL, "
                    + "price BIGINT NOT NULL, buyer_id BIGINT, "
                    + "height INT NOT NULL, latest BOOLEAN DEFAULT TRUE NOT NULL, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 16:
            ...
            case 19:
                apply("CREATE TABLE IF NOT EXISTS trade (db_id SERIAL, asset_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
                    ...
                    + "quantity BIGINT NOT NULL, price BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 20:
            ...
            case 23:
                apply("CREATE TABLE IF NOT EXISTS ask_order (db_id SERIAL, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    ...
                    + "latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 24:
            ...
            case 27:
                apply("CREATE TABLE IF NOT EXISTS bid_order (db_id SERIAL, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    + "asset_id BIGINT NOT NULL, price BIGINT NOT NULL, transaction_index SMALLINT NOT NULL, "
                    + "transaction_height INT NOT NULL, "
                    + "quantity BIGINT NOT NULL, creation_height INT NOT NULL, height INT NOT NULL, "
                    + "latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            ...
            case 35:
                apply("CREATE TABLE IF NOT EXISTS purchase (db_id SERIAL, id BIGINT NOT NULL, buyer_id BIGINT NOT NULL, "
                    + "goods_id BIGINT NOT NULL, "
                    + "seller_id BIGINT NOT NULL, quantity INT NOT NULL, "
                    + "price BIGINT NOT NULL, deadline INT NOT NULL, note BLOB, nonce BINARY(32), "
                    + "`TIMESTAMP` INT NOT NULL, pending BOOLEAN NOT NULL, goods BLOB, goods_nonce BINARY(32), goods_is_text BOOLEAN NOT NULL DEFAULT TRUE, "
                    + "refund_note BLOB, refund_nonce BINARY(32), has_feedback_notes BOOLEAN NOT NULL DEFAULT FALSE, "
                    + "has_public_feedbacks BOOLEAN NOT NULL DEFAULT FALSE, discount BIGINT NOT NULL, refund BIGINT NOT NULL, "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 36:
            ...
            case 40:
                apply("CREATE TABLE IF NOT EXISTS account (db_id SERIAL, id BIGINT NOT NULL, "
            ...
            case 42:
                apply("CREATE TABLE IF NOT EXISTS account_asset (db_id SERIAL, account_id BIGINT NOT NULL, "
            ...
            case 44:
                apply("CREATE TABLE IF NOT EXISTS account_guaranteed_balance (db_id SERIAL, account_id BIGINT NOT NULL, "
                    + "additions BIGINT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 45:
            ...
            case 46:
                apply("CREATE TABLE IF NOT EXISTS purchase_feedback (db_id SERIAL, id BIGINT NOT NULL, feedback_data BLOB NOT NULL, "
                    + "feedback_nonce BINARY(32) NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 47:
                apply("CREATE INDEX IF NOT EXISTS purchase_feedback_id_height_idx ON purchase_feedback (id, height DESC)");
            case 48:
                apply("CREATE TABLE IF NOT EXISTS purchase_public_feedback (db_id SERIAL, id BIGINT NOT NULL, public_feedback "
                    + "VARCHAR(255) NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 49:
                apply("CREATE INDEX IF NOT EXISTS purchase_public_feedback_id_height_idx ON purchase_public_feedback (id, height DESC)");
            case 50:
                apply("CREATE TABLE IF NOT EXISTS unconfirmed_transaction (db_id SERIAL, id BIGINT NOT NULL, expiration INT NOT NULL, "
                    + "transaction_height INT NOT NULL, fee_per_byte BIGINT NOT NULL, arrival_timestamp BIGINT NOT NULL, "
                    + "transaction_bytes BLOB NOT NULL, prunable_json TEXT, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 51:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS unconfirmed_transaction_id_idx ON unconfirmed_transaction (id)");
            case 52:
                apply("CREATE TABLE IF NOT EXISTS asset_transfer (db_id SERIAL, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
                    + "sender_id BIGINT NOT NULL, recipient_id BIGINT NOT NULL, quantity BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, "
                    + "height INT NOT NULL) ENGINE=ROCKSDB;");
            case 53:
            ...
            case 62:
                apply("CREATE TABLE IF NOT EXISTS tag (db_id SERIAL, tag VARCHAR(150) NOT NULL, in_stock_count INT NOT NULL, "
                    + "total_count INT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 63:
            ...
            case 68:
                apply("CREATE TABLE IF NOT EXISTS account_currency (db_id SERIAL, account_id BIGINT NOT NULL, "
            ...
            case 70:
                apply("CREATE TABLE IF NOT EXISTS currency_founder (db_id SERIAL, currency_id BIGINT NOT NULL, "
            ...
            case 72:
                apply("CREATE TABLE IF NOT EXISTS currency_mint (db_id SERIAL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    + "counter BIGINT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 73:
            ...
            case 74:
                apply("CREATE TABLE IF NOT EXISTS buy_offer (db_id SERIAL, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL,"
                    + "rate BIGINT NOT NULL, unit_limit BIGINT NOT NULL, supply BIGINT NOT NULL, expiration_height INT NOT NULL,"
                    + "creation_height INT NOT NULL, transaction_index SMALLINT NOT NULL, transaction_height INT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 75:
            ...
            case 77:
                apply("CREATE TABLE IF NOT EXISTS sell_offer (db_id SERIAL, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    + "rate BIGINT NOT NULL, unit_limit BIGINT NOT NULL, supply BIGINT NOT NULL, expiration_height INT NOT NULL, "
                    + "creation_height INT NOT NULL, transaction_index SMALLINT NOT NULL, transaction_height INT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 78:
            ...
            case 80:
                apply("CREATE TABLE IF NOT EXISTS exchange (db_id SERIAL, transaction_id BIGINT NOT NULL, currency_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
                    + "offer_id BIGINT NOT NULL, seller_id BIGINT NOT NULL, "
                    + "buyer_id BIGINT NOT NULL, units BIGINT NOT NULL, "
                    + "rate BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 81:
            ...
            case 85:
                apply("CREATE TABLE IF NOT EXISTS currency_transfer (db_id SERIAL, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, "
            ...
            case 96:
                apply("CREATE TABLE IF NOT EXISTS scan (rescan BOOLEAN NOT NULL DEFAULT FALSE, height INT NOT NULL DEFAULT 0, "
                    + "validate BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 97:
            ...
            case 99:
                apply("CREATE TABLE IF NOT EXISTS currency_supply (db_id SERIAL, id BIGINT NOT NULL, "
            ...
            case 101:
                apply("CREATE TABLE IF NOT EXISTS public_key (db_id SERIAL, account_id BIGINT NOT NULL, "
                    + "public_key BINARY(32), height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 102:
            ...
            case 107:
                apply("CREATE TABLE IF NOT EXISTS vote (db_id SERIAL, id BIGINT NOT NULL, " +
                    "poll_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, vote_bytes BLOB NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 108:
            ...
            case 111:
                apply("CREATE TABLE IF NOT EXISTS poll_result (db_id SERIAL, poll_id BIGINT NOT NULL, "
                    + "result BIGINT, weight BIGINT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 112:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll (db_id SERIAL, id BIGINT NOT NULL, "
                    ...
                    + "hashed_secret BLOB, algorithm TINYINT, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 113:
                apply("CREATE TABLE IF NOT EXISTS phasing_vote (db_id SERIAL, vote_id BIGINT NOT NULL, "
                    + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                    + "height INT NOT NULL) ENGINE=ROCKSDB;");
            case 114:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_voter (db_id SERIAL, "
                    + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                    + "height INT NOT NULL) ENGINE=ROCKSDB;");
            case 115:
            ...
            case 128:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_result (db_id SERIAL, id BIGINT NOT NULL, "
                    + "result BIGINT NOT NULL, approved BOOLEAN NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 129:
            ...
            case 138:
                apply("CREATE TABLE IF NOT EXISTS prunable_message (db_id SERIAL, id BIGINT NOT NULL, sender_id BIGINT NOT NULL, "
                    + "recipient_id BIGINT, message BLOB, message_is_text BOOLEAN NOT NULL, is_compressed BOOLEAN NOT NULL, "
                    + "encrypted_message BLOB, encrypted_is_text BOOLEAN DEFAULT FALSE, "
                    + "block_timestamp INT NOT NULL, transaction_timestamp INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 139:
            ...
            case 144:
                apply("CREATE TABLE IF NOT EXISTS tagged_data (db_id SERIAL, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    + "name VARCHAR(255) NOT NULL, description VARCHAR(255), tags VARCHAR(255), parsed_tags JSON CHECK (JSON_VALID(parsed_tags)), type VARCHAR(255), data BLOB NOT NULL, "
                    + "is_text BOOLEAN NOT NULL, channel VARCHAR(255), filename VARCHAR(255), block_timestamp INT NOT NULL, transaction_timestamp INT NOT NULL, "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 145:
            ...
            case 149:
                apply("CREATE TABLE IF NOT EXISTS data_tag (db_id SERIAL, tag VARCHAR(150) NOT NULL, tag_count INT NOT NULL, "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 150:
            ...
            case 152:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_timestamp (db_id SERIAL, id BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 153:
            ...
            case 156:
                apply("CREATE TABLE IF NOT EXISTS account_lease (db_id SERIAL, lessor_id BIGINT NOT NULL, "
            ...
            case 187:
                apply("CREATE TABLE IF NOT EXISTS exchange_request (db_id SERIAL, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                    + "currency_id BIGINT NOT NULL, units BIGINT NOT NULL, rate BIGINT NOT NULL, is_buy BOOLEAN NOT NULL, "
                    + "`TIMESTAMP` INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 188:
            ...
            case 193:
                apply("CREATE TABLE IF NOT EXISTS account_ledger (db_id SERIAL, account_id BIGINT NOT NULL, "
                    ...
                    + "block_id BIGINT NOT NULL, height INT NOT NULL, `TIMESTAMP` INT NOT NULL) ENGINE=ROCKSDB;");
            case 194:
            ...
            case 196:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_extend (db_id SERIAL, id BIGINT NOT NULL, "
                    + "extend_id BIGINT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 197:
            ...
            case 202:
                apply("CREATE TABLE IF NOT EXISTS shuffling (db_id SERIAL, id BIGINT NOT NULL, holding_id BIGINT NULL, holding_type TINYINT NOT NULL, "
                    ...
                    + "recipient_public_keys BLOB, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 203:
            ...
            case 207:
                apply("CREATE TABLE IF NOT EXISTS shuffling_participant (db_id SERIAL, shuffling_id BIGINT NOT NULL, "
                    + "account_id BIGINT NOT NULL, next_account_id BIGINT NULL, participant_index TINYINT NOT NULL, "
                    + "state TINYINT NOT NULL, blame_data BLOB, key_seeds BLOB, data_transaction_full_hash BINARY(32), data_hash BINARY(32), "
                    + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 208:
            ...
            case 213:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_linked_transaction (db_id SERIAL, "
            ...
            case 217:
                apply("CREATE TABLE IF NOT EXISTS account_control_phasing (db_id SERIAL, account_id BIGINT NOT NULL, "
                    + "whitelist JSON CHECK (JSON_VALID(whitelist)), voting_model TINYINT NOT NULL, quorum BIGINT, min_balance BIGINT, "
            ...
            case 220:
                apply("CREATE TABLE IF NOT EXISTS account_property (db_id SERIAL, id BIGINT NOT NULL, recipient_id BIGINT NOT NULL, setter_id BIGINT, "
                    + "property VARCHAR(255) NOT NULL, `VALUE` VARCHAR(255), height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE, deleted BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=ROCKSDB;");
            case 221:
            ...
            case 225:
                apply("CREATE TABLE IF NOT EXISTS asset_delete (db_id SERIAL, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
                    + "account_id BIGINT NOT NULL, quantity BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 226:
            ...
            case 230:
                apply("CREATE TABLE IF NOT EXISTS referenced_transaction (db_id SERIAL, transaction_id BIGINT NOT NULL, "
                    + "referenced_transaction_id BIGINT NOT NULL) ENGINE=ROCKSDB;");
            case 231:
            ...
            case 233:
                apply("CREATE TABLE IF NOT EXISTS asset_dividend (db_id SERIAL, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
                    + "amount BIGINT NOT NULL, dividend_height INT NOT NULL, total_dividend BIGINT NOT NULL, "
                    + "num_accounts BIGINT NOT NULL, `TIMESTAMP` INT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 234:
            ...
            case 241:
                apply("CREATE TABLE IF NOT EXISTS genesis_public_key " +
                    ...
                    "height INT NOT NULL, " +
                    "latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 242:
            ...
            case 252:
                ...
                apply("CREATE TABLE IF NOT EXISTS shard (shard_id BIGINT NOT NULL, shard_hash BLOB, " +
                    "shard_height INT not null default 0, shard_state BIGINT default 0, zip_hash_crc BLOB, generator_ids JSON DEFAULT NULL CHECK (JSON_VALID(generator_ids)), block_timeouts JSON DEFAULT NULL CHECK (JSON_VALID(block_timeouts)), block_timestamps JSON DEFAULT NULL CHECK (JSON_VALID(block_timestamps)), prunable_zip_hash BLOB DEFAULT NULL) ENGINE=ROCKSDB;");
            case 253:
                apply("alter table shard add constraint PRIMARY_KEY_SHARD_ID primary key IF NOT EXISTS (shard_id)"); // primary key + index
            case 254:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS shard_height_index on shard (shard_height DESC, shard_id)");
            case 255:
                apply("CREATE TABLE IF NOT EXISTS block_index (block_id BIGINT NOT NULL, block_height INT NOT NULL) ENGINE=ROCKSDB;");
            case 256:
            ...
            case 258:
                apply("CREATE TABLE IF NOT EXISTS transaction_shard_index (transaction_id BIGINT NOT NULL, partial_transaction_hash BLOB NOT NULL, transaction_index SMALLINT NOT NULL, height INT NOT NULL) ENGINE=ROCKSDB;");
            case 259:
            ...
            case 263:
                apply("ALTER TABLE shard_recovery ADD CONSTRAINT shard_recovery_id_state_object_idx unique IF NOT EXISTS (shard_recovery_id, state)");
            case 264:
                apply(null);
            case 265:
            ...
            case 270:
                apply("CREATE TABLE IF NOT EXISTS dex_offer (db_id SERIAL NOT NULL, transaction_id BIGINT NOT NULL, type TINYINT NOT NULL, " +
                    "account_id BIGINT NOT NULL, offer_currency TINYINT NOT NULL, offer_amount BIGINT NOT NULL, pair_currency TINYINT NOT NULL, " +
                    "pair_rate BIGINT NOT NULL, finish_time INT NOT NULL, status TINYINT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE) ENGINE=ROCKSDB;");
            case 271:
            ...
            case 281:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS zip_hash_crc BLOB");
            case 282:
            ...
            case 293:
                apply("CREATE UNIQUE INDEX IF NOT EXISTS block_index_block_id_idx ON block_index (block_id)");
            case 294:
                apply("ALTER TABLE shard MODIFY shard_id BIGINT NOT NULL");
            case 295:
                apply("ALTER TABLE shuffling_participant ADD COLUMN IF NOT EXISTS data_hash BINARY(32)");
            case 296:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS generator_ids JSON DEFAULT NULL CHECK (JSON_VALID(generator_ids))");
            case 297:
            ...
            case 301:
                apply("CREATE TABLE IF NOT EXISTS dex_contract (db_id SERIAL NOT NULL, id BIGINT NOT NULL, offer_id BIGINT NOT NULL, " +
                    ...
                    " deadline_to_reply INT NOT NULL) ENGINE=ROCKSDB;");
            case 302:
                apply("CREATE TABLE IF NOT EXISTS dex_trade (db_id SERIAL NOT NULL, transaction_id BIGINT not null, sender_offer_id BIGINT not null, " +
                    ...
                    "HEIGHT INT not null ) ENGINE=ROCKSDB;");
            case 303:
                apply("ALTER TABLE shard ADD COLUMN IF NOT EXISTS prunable_zip_hash BLOB DEFAULT NULL");
            case 304:
            ...
            case 311:
                apply("CREATE TABLE IF NOT EXISTS phasing_approval_tx (db_id SERIAL NOT NULL, phasing_tx BIGINT NOT NULL, approved_tx BIGINT NOT NULL," +
                    " height INT NOT NULL) ENGINE=ROCKSDB;");
            case 312:
                apply(null);
            case 313:
            ...
            case 316:
                apply("CREATE TABLE IF NOT EXISTS mandatory_transaction " +
                    "(db_id SERIAL, id BIGINT NOT NULL, transaction_bytes BLOB NOT NULL, required_tx_hash BINARY(32)) ENGINE=ROCKSDB;");
            case 317:
                apply("CREATE INDEX IF NOT EXISTS dex_offer_overdue_idx ON dex_offer (status, finish_time)");
            case 318:
                apply("CREATE TABLE IF NOT EXISTS dex_transaction (db_id SERIAL, hash BLOB NOT NULL, tx BLOB NOT NULL, operation TINYINT NOT NULL, params VARCHAR(255) NOT NULL, account VARCHAR(255) NOT NULL, timestamp BIGINT) ENGINE=ROCKSDB;");
            case 319:
                apply("CREATE TABLE IF NOT EXISTS user_error_message(db_id SERIAL, address VARCHAR(255) NOT NULL, error VARCHAR(255) NOT NULL, operation VARCHAR(255), details VARCHAR(255), timestamp BIGINT NOT NULL) ENGINE=ROCKSDB;");
            case 320:
            ...
            case 323:
                apply("CREATE TABLE order_scan (coin TINYINT NOT NULL, last_db_id BIGINT NOT NULL) ENGINE=ROCKSDB;");
            case 324:
            ...
            case 328:
                apply("ALTER TABLE account_lease DROP COLUMN IF EXISTS id"); // revert account_lease changes ('deleted' column is used instead)
            case 329:
                apply("ALTER TABLE account_lease ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 330:
                apply("ALTER TABLE account ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 331:
                apply("ALTER TABLE account_info ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 332:
                apply("ALTER TABLE account_property ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 333:
                apply("ALTER TABLE account_asset ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 334:
                apply("ALTER TABLE account_currency ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 335:
                apply("ALTER TABLE currency_founder ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 336:
                apply("ALTER TABLE asset ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 337:
                apply("ALTER TABLE currency ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 338:
                apply("ALTER TABLE ask_order ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 339:
                apply("ALTER TABLE bid_order ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 340:
                apply("ALTER TABLE sell_offer ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 341:
                apply("ALTER TABLE buy_offer ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 342:
                apply("ALTER TABLE account_control_phasing ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 343:
                apply("ALTER TABLE currency_mint ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 344:
                apply("ALTER TABLE currency_supply ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 345:
                apply("ALTER TABLE shuffling ADD COLUMN IF NOT EXISTS deleted BOOLEAN NOT NULL DEFAULT FALSE");
            case 346:
