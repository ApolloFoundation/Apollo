...
public class TransactionTypes {
    ...
    public static final byte SUBTYPE_MONETARY_SYSTEM_CURRENCY_BURN = 9;
    ...
    public enum TransactionTypeSpec {
        ...
        MS_CURRENCY_BURNING(TYPE_MONETARY_SYSTEM, SUBTYPE_MONETARY_SYSTEM_CURRENCY_BURN, "CurrencyBurn"),
