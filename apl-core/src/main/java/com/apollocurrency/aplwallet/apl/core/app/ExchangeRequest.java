...
public final class ExchangeRequest {
    ...
    static void addExchangeRequest(Transaction transaction, MonetarySystemExchangeBuy attachment) {
    ...
    private ExchangeRequest(Transaction transaction, MonetarySystemExchangeBuy attachment) {
    ...
    private ExchangeRequest(Transaction transaction, MonetarySystemExchange attachment, boolean isBuy) {
