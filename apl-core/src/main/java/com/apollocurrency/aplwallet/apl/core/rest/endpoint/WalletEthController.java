...
import com.apollocurrency.aplwallet.api.response.EthTransferResponce;
...
public class WalletEthController {
    ...
    public Response transferEth(@FormParam("account") String account,
        ...
        Response.ResponseBuilder response = Response.ok(new EthTransferResponce(transferHash));
        return response.build();
    }
