...
public class ShufflingParticipantMapper extends VersionedDerivedEntityMapper<ShufflingParticipant> {
    ...
    public ShufflingParticipant doMap(ResultSet rs, StatementContext ctx) throws SQLException {
        ...
        ParticipantState state = ParticipantState.get(rs.getByte("state"));
        ...
        return new ShufflingParticipant(null, null, shufflingId, accountId, index, nextAccountId, state, dataTransactionFullHash, dataHash, blameData, keySeeds);
    }
}
