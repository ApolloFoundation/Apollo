...
public class CreateTransactionSenderRecipientForm {
    ...
    @FormParam("phasingFinishHeight") @DefaultValue("-1") Integer phasingFinishHeight = -1;

    @Parameter @Schema(description = "The expected voting model of the phasing", implementation = VoteWeighting.VotingModel.class)
    @FormParam("phasingVotingModel") @DefaultValue("NONE") VoteWeighting.VotingModel phasingVotingModel = VoteWeighting.VotingModel.NONE;

    @Parameter(description = "The expected phasing quorum")
    @DefaultValue("0") @FormParam("phasingQuorum") Long phasingQuorum = 0L;

    @Parameter(description = "The minimum phasing quorum")
    @DefaultValue("0") @FormParam("phasingMinBalance") Long phasingMinBalance = 0L;

    @Parameter(description = "Phasing holding id")
    @DefaultValue("0") @FormParam("phasingHolding") Long phasingHolding = 0L;
    ...
    @FormParam("phasingMinBalanceModel") @DefaultValue("NONE") VoteWeighting.VotingModel phasingMinBalanceModel = VoteWeighting.VotingModel.NONE;
    ...
    @DefaultValue("0") @FormParam("phasingHashedSecretAlgorithm") Byte phasingHashedSecretAlgorithm = 0;
    ...
    @DefaultValue("0") @FormParam("ecBlockId") Long ecBlockId = 0L;

    @Parameter(description = "ec Block Height")
    @DefaultValue("0") @FormParam("ecBlockHeight") Integer ecBlockHeight = 0;
    ...
    @FormParam("code2FA") @DefaultValue("0") Integer code2FA = 0;
