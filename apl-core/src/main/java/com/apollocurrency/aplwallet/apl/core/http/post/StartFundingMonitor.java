...
public final class StartFundingMonitor extends AbstractAPIRequestHandler {
    ...
    public JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long amount = HttpParameterParser.getLong(req, "amount", 0, Long.MAX_VALUE, true);
        ...
        long threshold = HttpParameterParser.getLong(req, "threshold", 0, Long.MAX_VALUE, true);
        ...
        int interval = HttpParameterParser.getInt(req, "interval", FundingMonitor.MIN_FUND_INTERVAL, Integer.MAX_VALUE, true);
