...
import com.apollocurrency.aplwallet.apl.core.http.EventListener;
import com.apollocurrency.aplwallet.apl.core.http.EventListener.EventListenerException;
import com.apollocurrency.aplwallet.apl.core.http.EventListener.PendingEvent;
 ...
 * apl.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than apl.apiEventTimeout.</li>
 * </ul>
 *
...
public class EventWait extends AbstractAPIRequestHandler {
     ...
     * @return                      JSON stream
     */
    public static JSONObject formatResponse(List<PendingEvent> events) {
