...
public final class GetDGSPendingPurchases extends AbstractAPIRequestHandler {
    ...
    public JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        ...
        long sellerId = HttpParameterParser.getAccountId(req, "seller", true);
        ...
        try (DbIterator<DGSPurchase> purchases = service.getPendingSellerPurchases(sellerId, firstIndex, lastIndex)) {
