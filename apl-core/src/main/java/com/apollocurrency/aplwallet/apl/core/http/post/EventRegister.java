...
import com.apollocurrency.aplwallet.apl.core.http.EventListener.EventRegistration;
 ...
 * issue an EventWait before the time interval specified by apl.apiEventTimeout
 ...
 * specified by apl.apiMaxEventUsers has been reached.</p>
 *
