...
//    };
     ...
     * @param dataSourceCreator db creator
     */
    @Inject
    public DatabaseManagerImpl(@NonNull DbConfig dbConfig, @NonNull DataSourceCreator dataSourceCreator) {
        ...
        this.baseDbProperties = dbConfig.getDbProperties();
        this.dataSourceCreator = Objects.requireNonNull(dataSourceCreator);
        initDatasource();
        this.available = true;
    }
