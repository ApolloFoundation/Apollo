...
public enum LedgerEvent {
    ...
    SHUFFLING_REGISTRATION(51, true), SHUFFLING_PROCESSING(52, true), SHUFFLING_CANCELLATION(53, true), SHUFFLING_DISTRIBUTION(54, true),
    // TYPE_UPDATE
    ...
    SMC_PUBLISH(70, true), SMC_CALL_METHOD(71, true)
    ;
    /**
     * Event code mapping
     */
