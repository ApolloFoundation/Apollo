...
public enum LedgerEvent {
    ...
    DEX_REFUND_FROZEN_MONEY(62, true), DEX_FREEZE_MONEY(63, true), DEX_TRANSFER_MONEY(64, true), UPDATE_V2(65, true), CHILD_CREATE(66, true), CHILD_CONVERT_TO(67, true),
    CURRENCY_BURNING(68, true), FAILED_VALIDATION_TRANSACTION_FEE(69, true), FAILED_EXECUTION_TRANSACTION_FEE(70, true),
    SMC_PUBLISH(71, true), SMC_CALL_METHOD(72, true), SMC_REFUNDED_FEE(73, true);
    /**
     * Event code mapping
     */
