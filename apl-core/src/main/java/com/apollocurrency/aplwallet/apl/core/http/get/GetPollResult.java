...
public class GetPollResult extends AbstractAPIRequestHandler {
    ...
    public JSONStreamAware processRequest(HttpServletRequest req) throws AplException {
        Poll poll = HttpParameterParser.getPoll(req);
        ...
        if (Convert.emptyToNull(req.getParameter("votingModel")) == null) {
            ...
            long holdingId = HttpParameterParser.getLong(req, "holding", Long.MIN_VALUE, Long.MAX_VALUE, false);
            long minBalance = HttpParameterParser.getLong(req, "minBalance", 0, Long.MAX_VALUE, false);
            byte minBalanceModel = HttpParameterParser.getByte(req, "minBalanceModel", (byte)0, (byte)3, false);
