...
public enum ApiErrors implements ErrorInfo {
    ...
    REST_API_SERVER_ERROR(1, 2021, "REST API error: ''%s'', see server's log for details"),
    ...
    DEX_NOT_ENOUGH_FEE(6, 2017, "Not enough {0} for a fee. Min value is {1} {0}"),
    OVERFLOW(11, 2018, "Overflow for value ''{0}''"),
    OVERFLOW_PARAM(11, 2019, "Overflow in param name ''{0}'' for value ''{1}''");
