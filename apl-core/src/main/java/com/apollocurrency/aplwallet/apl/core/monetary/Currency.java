    ...
    private void save(Connection con) throws SQLException {
        try (
            ...
            PreparedStatement pstmt = con.prepareStatement("INSERT INTO currency (id, account_id, `name`, name_lower, code, "
                ...
                + "id = VALUES(id), account_id = VALUES(account_id), `name` = VALUES(`name`), name_lower = VALUES(name_lower), "
            ...
            final String nameParam = this.name;
            Objects.requireNonNull(nameParam);
            int i = 0;
            pstmt.setLong(++i, this.currencyId);
            pstmt.setLong(++i, this.accountId);
            pstmt.setString(++i, nameParam);
            pstmt.setString(++i, nameParam.toLowerCase(Locale.US));
        ...
        private void save(Connection con) throws SQLException {
            try (
                ...
                PreparedStatement pstmt = con.prepareStatement("INSERT INTO currency_supply (id, current_supply, "
                    ...
                    + "VALUES (?, ?, ?, ?, TRUE, FALSE) "
                    + "ON DUPLICATE KEY UPDATE "
                    + "id = VALUES(id), current_supply = VALUES(current_supply), current_reserve_per_unit_atm = VALUES(current_reserve_per_unit_atm), "
